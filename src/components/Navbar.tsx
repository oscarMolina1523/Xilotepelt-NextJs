        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            <div className="relative group">
              <div
                className={`nav-link flex items-center gap-1 ${
                  scrolled
                    ? "text-gray-800"
                    : "text-white hover:text-xilo-yellow"
                } cursor-pointer`}
              >
                Primer Equipo
              ...
              <div className="absolute left-0 hidden group-hover:block bg-white rounded-lg shadow-lg py-2 w-48 z-50">
                ...
                <div
                  onClick={() =>
                    handleNavigation("/primer-equipo/clasificacion")
                  }
                  className="px-4 py-2 hover:bg-xilo-blue/10 text-gray-700 hover:text-xilo-blue cursor-pointer"
                >
                  Clasificación
            ...
            <div
              ...
              className={`nav-link ${
                scrolled ? "text-gray-800" : "text-white hover:text-xilo-yellow"
              } cursor-pointer`}
            >
              El Club
            </div>
            ...
            <div
              ...
              className={`nav-link ${
                scrolled ? "text-gray-800" : "text-white hover:text-xilo-yellow"
              } cursor-pointer bg-xilo-blue/20 px-3 py-1 rounded-md`}
            >
              Contacto
            </div>
            ...
            <div className="flex flex-col space-y-1">
              ...
              <details className="group">
                <summary className="flex items-center justify-between px-4 py-2 cursor-pointer hover:bg-gray-100">
                  <span className="text-xilo-blue font-medium">
                    Primer Equipo
                  </span>
                ...
                <div className="pl-8 bg-gray-50">
                  ...
                  <div
                    onClick={() =>
                      handleNavigation("/primer-equipo/resultados")
                    }
                    className="px-4 py-2 hover:bg-xilo-blue/10 cursor-pointer"
                  >
                    Resultados
